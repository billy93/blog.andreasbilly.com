...
const BuildWith = () => (
  <div className="flex items-center space-x-1">
    ...
    <div className="flex space-x-1.5">
      <Link href="https://nextjs.org?ref=blog.andreasbilly.com">
        <BrandIcon type="NextJS" className="h-5 w-5" />
      </Link>
      <Link href="https://tailwindcss.com?ref=blog.andreasbilly.com">
        <BrandIcon type="TailwindCSS" className="h-5 w-5" />
      </Link>
      <Link href="https://www.typescriptlang.org?ref=blog.andreasbilly.com">
        <BrandIcon type="Typescript" className="h-5 w-5" />
      </Link>
      <Link href="https://umami.is?ref=blog.andreasbilly.com" className="pl-px">
